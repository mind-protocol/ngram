...
|------|---------|----------------------|-------|--------|
| `ngram/core_utils.py` | core helper functions and constants | `get_templates_path`, `find_module_directories` | ~106 | OK |
...
|---------|------------|---------|
| Guarded fallback | `ngram/core_utils.py:get_templates_path` | Select the first valid templates location with a clear fallback order |
| Prefix-based discovery | `ngram/core_utils.py:find_module_directories` | Identify module docs without hard-coding names |
...
|-------------|-----------|--------------|
| `get_templates_path` | `ngram/core_utils.py:36` | CLI or templates lookup calls |
| `find_module_directories` | `ngram/core_utils.py:67` | docs scanning utilities |
...
|---------|----------|-------------|
| `pathlib` | filesystem paths and checks | `ngram/core_utils.py` |
| `typing` | type hints | `ngram/core_utils.py` |
| `yaml` (optional) | YAML detection via import | `ngram/core_utils.py` |
...
|-------|----------|-------|-----------|
| `HAS_YAML` | `ngram/core_utils.py:10` | module | set at import time |
| `IGNORED_EXTENSIONS` | `ngram/core_utils.py:17` | module | constant at import time |
...
| File | Line | Reference |
|------|------|-----------|
| `ngram/core_utils.py` | 4 | `DOCS: docs/core_utils/PATTERNS_Core_Utils_Functions.md` |

### Docs → Code

| Doc Section | Implemented In |
|-------------|----------------|
| ALGORITHM get_templates_path | `ngram/core_utils.py:get_templates_path` |
| ALGORITHM find_module_directories | `ngram/core_utils.py:find_module_directories` |
| BEHAVIOR B1 | `ngram/core_utils.py:get_templates_path` |
| BEHAVIOR B3 | `ngram/core_utils.py:find_module_directories` |

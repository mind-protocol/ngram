...
|--------|--------------|-------------|
| `ngram/cli.py` | `dispatch_command()` | command exit code |
| `ngram/doctor.py` | `run_doctor()` | health score + SYNC update |
| `ngram/repair.py` | `run_repair()` | repair report + artifacts |

# Context Protocol CLI — Algorithm: Command Processing Logic
...
write to .context-protocol/state/SYNC_Project_Health.md
```
...
save to .context-protocol/state/REPAIR_REPORT.md
```

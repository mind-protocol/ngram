...
ngram symbols [--folder DIR] [--graph NAME] [--dry-run] [--verbose]

# With doctor scan
ngram doctor --symbols [--graph NAME]
```
...
include_dirs = ['engine/', 'ngram/', 'tools/', 'tests/']
exclude_patterns = [
    '**/node_modules/**',
    '**/__pycache__/**',
    '**/.git/**',
...
1. CLI: `ngram symbols`
2. CLI: `ngram doctor --symbols`
3. Python: `from ngram.symbol_extractor import SymbolExtractor`
4. Direct: `python -m ngram.symbol_extractor --help`

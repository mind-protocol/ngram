...
@ngram:id: SYNC.COVERAGE.VALIDATION.SYSTEM
...
|----------|------------|-------|
| doc_health | D-UNDOC-CODE, D-PLACEHOLDER-DOCS, D-ORPHAN-DOCS, D-STALE-SYNC, D-INCOMPLETE-CHAIN | ngram.create_module_docs, ngram.update_sync |
| module_def | D-NO-MAPPING, D-NO-OBJECTIVES, D-NO-PATTERNS | ngram.module_define_boundaries |
| code_struct | D-MONOLITH, D-NO-IMPL-DOC | ngram.implement_with_docs |
| health_ver | D-NO-HEALTH, D-VALIDATION-NO-HEALTH | ngram.health_define_and_verify |
| escalation | D-STUCK-MODULE, D-UNRESOLVED-ESC, D-TODO-ROT | ngram.debug_investigate |

...
|------|-----|------|-----------|
| doc_files | `ngram/doc_extractor.py::DocExtractor.extract` | — | input |
| yaml_parser | `ngram/doc_extractor.py::_extract_yaml_blocks` | — | input |
| marker_parser | `ngram/doc_extractor.py::_extract_markers` | — | input |

### Output Docks

| Dock | URI | Line | Direction |
|------|-----|------|-----------|
| cluster_result | `ngram/cluster_builder.py::ClusterBuilder.build_cluster` | — | output |
| upsert_stats | `ngram/cluster_builder.py::ClusterBuilder.upsert` | — | output |

## Checkers

| Checker | Status | Priority | Implementation |
|---------|--------|----------|----------------|
| cluster_health_check | PENDING | HIGH | `ngram/cluster_health.py::check_all` |
...
@ngram:todo Implement ClusterBuilder class
@ngram:todo Add cluster health checks to doctor
@ngram:todo Create stability tests

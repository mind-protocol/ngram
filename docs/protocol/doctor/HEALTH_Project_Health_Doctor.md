...
- **Scoring Integrity:** Ensuring the health score accurately reflects the project's adherence to the ngram protocol.
...
checkers:
  - name: self_health_check
    purpose: Running doctor on the ngram project itself (dogfooding).
    status: active
    priority: high

...
- **Sync and Workflow**
    ...
    - **Special Markers**: Detects `@ngram&#58;escalation`, `@ngram&#58;proposition`, and `@ngram&#58;todo` markers in code and docs.
...
- **@ngram&#58;todo**
    ...
    - **Action**: Use `ngram solve-markers` to triage and assign tasks.
...
- `@ngram:todo:postponed 2025-12-23 Establish `@ngram:thing:docs/...` tagging and marker grammar before refactoring modules/areas.`

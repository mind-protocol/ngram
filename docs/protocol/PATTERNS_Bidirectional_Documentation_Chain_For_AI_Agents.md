...
- A tiny bootstrap (.ngram/CLAUDE.md + root AGENTS.md with Codex guidance, including protocol-first reading, no self-run TUI, verbose outputs, and parallel-work awareness)

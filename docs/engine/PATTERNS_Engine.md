...
```
THIS:            docs/engine/PATTERNS_Engine.md
...
Treat `engine/` as the authoritative runtime umbrella. Submodules (models, moments, moment graph, physics) carry their own chains, but the engine root defines scope, ownership, and shared expectations.

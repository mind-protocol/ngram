...
This document describes the observable behaviors of the data models within the `engine/models/` module. It focuses on how these Pydantic models behave when instantiated, validated, and converted, ensuring a consistent and predictable data contract across the game engine.

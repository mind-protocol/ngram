...
<!-- @ngram:todo Define bounded ranges for each modifier. -->
<!-- @ngram:todo Decide whether modulation applies pre- or post-decay. -->
<!-- @ngram:proposition Add debug sampling of applied frames. -->

...
|--------|---------------------|
| `engine/physics/tick.py` | Runs physics updates per tick |
| `engine/infrastructure/canon/` | Records surfaced moments |
| `engine/infrastructure/api/tempo.py` | Speed/stop/start controls |

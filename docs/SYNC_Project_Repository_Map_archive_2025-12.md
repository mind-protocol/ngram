...
Original file: SYNC_Project_Repository_Map.md
...
| What | Where |
|------|-------|
| Repository overview generator | `ngram/repo_overview.py` |
| Map output snapshot | `docs/SYNC_Project_Repository_Map.md` |
| Validation command | `ngram/validate.py` |

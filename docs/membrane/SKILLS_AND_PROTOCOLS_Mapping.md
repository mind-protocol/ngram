...
**Skill ID:** `ngram.create_module_docs`
...
**Skill ID:** `ngram.module_define_boundaries`
...
**Skill ID:** `ngram.implement_with_docs`
...
**Skill ID:** `ngram.health_define_and_verify`
...
**Skill ID:** `ngram.debug_investigate`
...
- **Parent:** SYNC_Membrane_System.md
- **Implements:** PATTERNS_Membrane_System.md (Skills and Protocols sections)

...
1. Event Model correctness — preserve core invariants.
2. Event Model clarity — keep observable outputs legible.
3. Event Model performance — stay within intended budgets.

...
1. State Store correctness — preserve core invariants.
2. State Store clarity — keep observable outputs legible.
3. State Store performance — stay within intended budgets.

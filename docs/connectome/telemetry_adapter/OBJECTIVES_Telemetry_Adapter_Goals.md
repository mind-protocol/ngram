...
1. Telemetry Adapter correctness — preserve core invariants.
2. Telemetry Adapter clarity — keep observable outputs legible.
3. Telemetry Adapter performance — stay within intended budgets.

# Skill: `ngram.author_agents`
@ngram:id: SKILL.META.AUTHOR_AGENTS.COGNITIVE_POSTURES
...
If blocked on posture definition → `@ngram:escalation` with specific gap → `@ngram:proposition` with best-guess posture → proceed and refine through use.
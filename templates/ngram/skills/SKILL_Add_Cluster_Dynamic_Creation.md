# Skill: `ngram.add_cluster`
@ngram:id: SKILL.PRIMITIVE.ADD_CLUSTER.DYNAMIC_CREATION
...
- `status`: possible -> active -> spoken -> decayed
...
- `@ngram:TODO <plan>`
- `@ngram:escalation <blocker>`
- `@ngram:proposition <suggestion>`

## Never-stop Rule

If blocked on cluster design, create minimal viable cluster (content + space + moment), add `@ngram:TODO` for enrichment later.

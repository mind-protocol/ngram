...
@ngram:id: SKILL.HEALTH.DEFINE_AND_VERIFY

## Maps to VIEW
`.ngram/views/VIEW_Health_Define_Health_Checks_And_Verify.md`

## Purpose
Define/extend health signals and verify via the real-time health sublayer; map indicators to VALIDATION invariants and docking points.

## Inputs (YAML)
```yaml
module: "<area/module>"
invariants: ["<VALIDATION ids>"]
```

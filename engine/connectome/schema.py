...
Usage:
    from engine.connectome.schema import validate_node, validate_link, SchemaError
...
NODE_TYPE_FIELDS = {
    ...
    "moment": {
        ...
        "prose": {"type": "string", "default": ""},  # alias for text
        "status": {
            "type": "enum",
...
LINK_BASE_FIELDS = {
    ...
    "conductivity": {"type": "float", "range": [0, 1], "default": 0.5},
...
FIELD_ALIASES = {
    "from": "node_a",
    "to": "node_b",
    "prose": "text",  # moment.prose -> moment.text
}

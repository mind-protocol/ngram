...
from engine.models.base import MomentStatus
from engine.models.links import LinkType
...
class CanonHolder:
    ...
    def no_contradiction(self, moment_id: str) -> Tuple[bool, List[str]]:
        ...
        """
        from engine.physics.tick_v1_2 import CONTRADICT_THRESHOLD
    ...
    def reject_moment(
        ...
        """
        from engine.physics.tick_v1_2 import REJECTION_RETURN_RATE
    ...
    def interrupt_moment(
        ...
        update_query = """
        MATCH (m:Moment {id: $id})
        SET m.status = 'interrupted', m.tick_resolved = $tick
        RETURN m.id
        """
        self.graph_queries.query(
            update_query,
    ...
    def override_moment(
        ...
        """
        from engine.physics.tick_v1_2 import emotion_proximity

...
Usage:
    ...
    python -m engine.physics.tick_runner until_next_moment --max-ticks 100
    python -m engine.physics.tick_runner until_completion_or_interruption --graph blood_ledger

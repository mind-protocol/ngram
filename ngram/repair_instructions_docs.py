...
"""
Documentation-related repair instructions.

This module contains repair prompts for documentation issues:
...
Extracted from repair_instructions.py to reduce file size.
"""

...
This module contains code/test/config repair instructions.
Documentation-related instructions are in repair_instructions_docs.py.
"""
...
from .repair_instructions_docs import get_doc_instructions

...
Usage:
    from ngram.symbol_extractor import SymbolExtractor

    extractor = SymbolExtractor(graph_name="ngram")
...
class PythonExtractor:
    ...
    def _is_external_module(self, module: str) -> bool:
        ...
        local_prefixes = ('engine', 'ngram', 'tools', 'app', 'tests')
...
class SymbolExtractor:
    ...
    def __init__(
        ...
        # Config
        self.include_dirs = ['engine/', 'ngram/', 'tools/', 'tests/']

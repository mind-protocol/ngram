...
VERIFICATION_CHECKS: Dict[str, List[VerificationCheck]] = {
    "UNDOCUMENTED": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('define_space')",
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('update_sync')",
    ...
    "INCOMPLETE_CHAIN": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('create_doc_chain')",
    ...
    "NO_DOCS_REF": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('add_implementation')",
    ...
    "MONOLITH": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('add_cluster')",
    ...
    "MISSING_TESTS": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('add_health_coverage')",
    ...
    "ESCALATION": [
        ...
        VerificationCheck(
            ...
            action_on_fail="Run membrane_start('capture_decision')",
...
def format_escalation_feedback(
    ...
    lines = [
        ...
        "### 1. Raise Escalation",
        "```",
        "membrane_start('raise_escalation')",
        "```",
        "",
...
def format_todo_suggestion(
    ...
    lines.extend([
        "",
        "Use `membrane_start('add_todo')` to create tracked TODOs.",
